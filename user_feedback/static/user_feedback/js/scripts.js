...
class DialogPage extends Component {
  ...
  updateRating = e => {
    ...
    for(let i=1; i<+e.target.id.substr(e.target.id.length - 1); i++){
      if (!document.getElementById("star-button-"+i).classList.contains("mdc-icon-button--on")){
        document.getElementById("star-button-"+i).classList.add("mdc-icon-button--on");
      }
    }
    for(let i=+e.target.id.substr(e.target.id.length - 1); i<=5; i++){
      document.getElementById("star-button-"+i).classList.remove("mdc-icon-button--on");
    }
  }
  ...
  render(){
    return (
      <div>
        <Icon id="user-feedback-button" primary={true} raised={true} onClick={()=>{
        ...
        <Dialog style="padding: 0; border: 0; width: 0;" ref={dlg=>{this.dlg=dlg;}}>
          <form id="feedback-form">
            ...
            <Dialog.Body scrollable={false}>
              <div>
                <FormField>
                  <Radio id="radio-1" name="feedback-type" onInput={this.updateType}/>
                  <label for="radio-1">Bug Report</label>
                </FormField>
                <FormField>
                  <Radio id="radio-2" name="feedback-type" onInput={this.updateType}/>
                  <label for="radio-2">Feature Request</label>
                </FormField>
                <FormField>
                  <Radio id="radio-3" name="feedback-type" onInput={this.updateType}/>
                  <label for="radio-3">Review</label>
                </FormField>
              </div>
              <div>
                <IconButton id="star-button-1" onClick={this.updateRating}>
                  <IconButton.Icon id="star-1" on>star</IconButton.Icon>
                  <IconButton.Icon id="star-border-1">star_border</IconButton.Icon>
                </IconButton>
                <IconButton id="star-button-2" onClick={this.updateRating}>
                  <IconButton.Icon id="star-2" on>star</IconButton.Icon>
                  <IconButton.Icon id="star-border-2">star_border</IconButton.Icon>
                </IconButton>
                <IconButton id="star-button-3" onClick={this.updateRating}>
                  <IconButton.Icon id="star-3" on>star</IconButton.Icon>
                  <IconButton.Icon id="star-border-3">star_border</IconButton.Icon>
                </IconButton>
                <IconButton id="star-button-4" onClick={this.updateRating}>
                  <IconButton.Icon id="star-4" on>star</IconButton.Icon>
                  <IconButton.Icon id="star-border-4">star_border</IconButton.Icon>
                </IconButton>
                <IconButton id="star-button-5" onClick={this.updateRating}>
                  <IconButton.Icon id="star-5" on>star</IconButton.Icon>
                  <IconButton.Icon id="star-border-5">star_border</IconButton.Icon>
                </IconButton>
              </div>
              <div>
        ...
        <Snackbar ref={snack=>{this.snack=snack;}}/>
      </div>
    );
  }
}
